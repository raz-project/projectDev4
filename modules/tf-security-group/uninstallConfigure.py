...
def parse_args():
    parser = argparse.ArgumentParser(description="Tear down the security group created by configure.py.")
    parser.add_argument("--sg-name", required=True, help="Security Group name to destroy (e.g. my-sg)")
...
def main():
    ...
    subprocess.run(["terraform", "destroy", "-auto-approve", "-var-file=terraform.tfvars.json"], check=True)
